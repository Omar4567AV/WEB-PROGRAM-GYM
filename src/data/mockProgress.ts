...
export const mockProgress: WeeklyEntry[] = [
  ...
  ...[8, 7, 6, 5, 4, 3, 2, 1].map((week, index) => ({
    ...
    mood: (['good', 'great', 'good', 'average', 'great', 'good', 'great', 'great'] as WeeklyEntry['mood'][])[index],
    energyLevel: 8,
  ...
  ...[8, 7, 6, 5, 4, 3, 2, 1].map((week, index) => ({
    ...
    mood: (['average', 'good', 'low', 'good', 'great', 'good', 'average', 'good'] as WeeklyEntry['mood'][])[index],
    energyLevel: 7,
    sleepQuality: 8,
